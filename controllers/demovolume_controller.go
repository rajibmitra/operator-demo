...
//+kubebuilder:rbac:groups=demo.rajib.xyz,resources=demovolumes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo.rajib.xyz,resources=demovolumes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo.rajib.xyz,resources=demovolumes/finalizers,verbs=update
